/*
  ...
  * Geolocate : Arguments- onload, onerror, latitude, longitude, location, name. Tracks current geolocation with navigation.
*/
(function(window) {
  // if ("undefined" == typeof Netflys) throw new Error("There have requires Netflys Lib JS.");
      ...
      let fn = {
        onchange: function (success, error) {
          ...
          if ('geolocation' in navigator === false) {
            console.error(new Error('Geolocation is not supported by your browser.'));
          }
          return navigator.geolocation.getCurrentPosition(function (position) {
            let req = new Netflys().ajax({
              method: "GET",
